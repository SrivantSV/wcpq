  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-2 top-[72px] flex h-5 w-5 items-center justify-center rounded-md bg-white/20 text-white/70 hover:bg-white/30 hover:text-white transition-colors z-10"
      >
        {sidebarCollapsed ? (

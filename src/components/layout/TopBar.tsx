...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/approvals': 'Approvals',
  '/job-orders/:jobId/estimation': 'Estimation',
  '/job-orders/:jobId/execution': 'Execution Tracking',
  '/finance': 'Finance & Invoices',
  '/finance/invoice': 'Invoice',
  '/reports': 'Reports & Analytics',
  '/reports/jobs-summary': 'Jobs Summary Report',
  '/reports/variance': 'Variance Report',
  '/reports/client-profitability': 'Client Profitability',
  '/reports/material-consumption': 'Material Consumption',
  '/reports/labor-utilization': 'Labor Utilization',
  '/reports/overhead-analysis': 'Overhead Analysis',
  '/reports/invoice-aging': 'Invoice Aging Report',
  '/reports/job': 'Job Costing Report',
  '/settings': 'Settings',
